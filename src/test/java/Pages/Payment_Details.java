...
{
	WaitForElementToBeVisible(driver,By.xpath("//ul//span[contains(text(),'Credit')]"),8000);	
	...
	WaitForElementToBeVisible(driver,By.xpath("//div//p[contains(text(),'Month')]"),7000);	
	...
	WaitForElementToBeVisible(driver,By.xpath("//div//p[contains(text(),'Year')]"),7000);	
